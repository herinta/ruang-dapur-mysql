 ...
 <a href="HomePage.php" class="flex items-center space-x-3 rtl:space-x-reverse">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 -ml-28" id="navbar-user">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="HomePage.php" class="block py-2 px-3 text-orange-600 bg-orange-700 rounded md:bg-transparent md:text-orange-700 md:p-0 md:dark:text-orange-500" aria-current="page">Home</a>
      </li>
      <li>
    ...
    <div class="bg-yellow-50 px-10 md:px-32 pb-32">
      <div
        class="content-1 flex flex-wrap items-center justify-between pt-32 md:flex md:flex-nowrap gap-10"
      >
        <div class="">
